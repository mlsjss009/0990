...
export default function GrantCTA() {
  ...
  const features = [
    { icon: Shield, text: "100% Secure Grants" },
      ...
      <div className="max-w-6xl mx-auto text-center px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="mb-16">
          ...
          <p className="text-xl text-orange-100 mb-12 leading-relaxed max-w-4xl mx-auto">
            Every dollar granted goes directly to programs that create lasting change. Join thousands of supporters who are making a difference in communities worldwide.
          </p>
        </div>
        ...
        <div className="mt-16 bg-white/10 backdrop-blur-md rounded-3xl p-8 max-w-2xl mx-auto">
          <h3 className="text-2xl font-bold mb-4">Why Your Grant Matters</h3>
          <p className="text-orange-100 leading-relaxed">
            98% of every grant goes directly to our programs. We maintain transparency through detailed financial reports and regular impact updates, ensuring your generosity creates maximum positive change.
          </p>
        </div>
      </div>
    </section>
